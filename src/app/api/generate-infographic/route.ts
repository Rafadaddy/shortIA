  ...
  try {
    ...
    if (action === "list") {
      ...
      const prompt = [
        ...
        "6. Genera un UNICO image_prompt en ENGLISH para Ideogram/DALL-E. Este prompt DEBE INCLUIR explicitamente el texto de la lista para que la IA lo escriba. Usa este formato: 'A vertical dark infographic poster containing the text: [TITULO]. 1. [item1] 2. [item2]...'.",
        "",
        ...
        JSON.stringify({
          ...
          image_prompt: "A dark infographic vertical poster with neon accents, containing the typography: 'TITLE. 1. First point. 2. Second point...'",
          items: [{
            num: "01",
            emoji: "emoji",
