...
export const shortTopicCategories: ShortTopicCategory[] = [
  {
    ...
    topics: [
      ...
      "El secreto del interés compuesto que los bancos ocultan",
      "Cómo salir de la carrera de la rata antes de los 30",
      "Libros prohibidos que te enseñan a hacer dinero",
      "La regla del 1% para lograr el éxito absoluto",
      "Cómo reprogramar tu cerebro para la abundancia",
      "El error financiero que te mantiene pobre"
    ]
  },
  {
    ...
    topics: [
      ...
      "Por qué las personas buenas atraen parejas tóxicas",
      "El secreto psicológico para volverte irresistible",
      "Señales de que esa persona es tu alma gemela",
      "Cómo superar un corazón roto usando la ciencia",
      "El error que todos cometen en su primera cita",
      "La teoría del hilo rojo del destino explicada"
    ]
  },
  {
    category: "Nicho: Psicología Oscura y Comportamiento",
    icon: "🧠",
    topics: [
      "Trucos psicológicos ilegales para dominar cualquier conversación",
      "El lado oscuro de la psicología que da miedo",
  ...
  {
    category: "Nicho: Curiosidades y Ciencia",
    icon: "🔬",
    topics: [
  ...
  {
    category: "Nicho: Historia Oculta",
    icon: "📜",
    topics: [
  ...
  {
    category: "Nicho: Desarrollo Personal y Biohacking",
    icon: "⚡",
    topics: [
