    ...
    <main className="min-h-[calc(100vh-4rem)] p-4 md:p-6 lg:p-12 selection:bg-purple-500/30">
      <div className="max-w-5xl mx-auto space-y-8 md:space-y-12">
        ...
        <div className="bg-slate-900/50 p-5 md:p-8 rounded-3xl border border-slate-800/60 shadow-2xl backdrop-blur-xl space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="space-y-2">
              ...
              <input
                ...
                list="topic-list" onFocus={(e) => e.target.select()} className="w-full bg-slate-950 border border-slate-800 rounded-xl p-3 text-slate-200 focus:border-purple-500 outline-none"
              />
              <datalist id="topic-list">
                <option value="🎲 Aleatorio / Sorpréndeme" />
                <option value="✨ Tema Libre (Borra esto y escribe el tuyo)" />
                {novelaTopics.map(n => <option key={n} value={n} />)}
              </datalist>
            </div>
            <div className="space-y-2">
          ...
          <button onClick={generateIdeas} disabled={isGeneratingIdeas} className="w-full py-4 rounded-xl font-bold bg-purple-600 hover:bg-purple-500 text-white disabled:opacity-50 flex items-center justify-center gap-2 transition-all">
