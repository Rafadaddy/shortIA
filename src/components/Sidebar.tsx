    ...
    <>
      ...
      <aside className="hidden md:flex flex-col w-64 bg-slate-900 border-r border-slate-800 h-screen fixed left-0 top-0">
        ...
        <nav className="flex-1 overflow-y-auto px-4 py-2 space-y-1 scrollbar-hide">
          ...
          <Link href="/videos-infantiles" className="flex items-center gap-3 px-3 py-2 text-slate-300 hover:text-white hover:bg-slate-800 rounded-lg transition-colors">
          ...
          <Link href="/historial" className="flex items-center gap-3 px-3 py-2 text-slate-300 hover:text-white hover:bg-slate-800 rounded-lg transition-colors">
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-slate-900 border-t border-slate-800 flex items-center justify-start p-2 z-50 pb-safe overflow-x-auto gap-2">
        <Link href="/historial" className="flex flex-col items-center gap-1 p-2 text-slate-400 hover:text-indigo-400 active:text-indigo-400 min-w-[4rem] flex-shrink-0">
          <FolderArchive className="w-5 h-5" />
          <span className="text-[10px] font-medium">Borradores</span>
        </Link>
        ...
        <Link href="/videos-infantiles" className="flex flex-col items-center gap-1 p-2 text-slate-400 hover:text-pink-400 active:text-pink-400 min-w-[4rem] flex-shrink-0">
          <Baby className="w-5 h-5" />
          <span className="text-[10px] font-medium">Infantil</span>
        </Link>
